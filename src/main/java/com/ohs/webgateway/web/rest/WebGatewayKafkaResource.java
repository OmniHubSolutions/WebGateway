...
@RestController
@RequestMapping("/api/web-gateway-kafka")
public class WebGatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WebGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WebGatewayKafkaResource(KafkaProperties kafkaProperties) {
